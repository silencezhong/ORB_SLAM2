...
public:
    ...
    {
        return (RECOVER_TYPE::FUNDAMENTAL_MATRIX == m_recoverType) ? m_MatchesInliersF : m_MatchesInliersH;
    }
...
private:
    ...
    vector<bool> m_MatchesInliersH;
    vector<bool> m_MatchesInliersF;
    RECOVER_TYPE m_recoverType;
};
